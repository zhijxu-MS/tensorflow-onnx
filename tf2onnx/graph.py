...
class Graph(object):
    ...
    def debug_output_names(self, output_info):
        """
        ONNX requires to specify shape and dtype info of output, so define a property to force user to specify these info
        detail of shape is not necessary while at least the dims info should be offered,
